...
pub use rocksdb_options::{
    ...
    HistogramData, IngestExternalFileOptions, LRUCacheOptions, MergeInstanceOptions, RateLimiter,
    ReadOptions, RestoreOptions, Statistics, WriteBufferManager, WriteOptions,
};
